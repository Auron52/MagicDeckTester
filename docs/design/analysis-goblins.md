...
- [ ] Sac-outlet Action kinds (Skirk mana / Siege-Gang damage / Pashalik tokens) — model on SacForMana (TurnSolver.h Kind). Enumerate in CollectActions, apply in rollout+executor, plan_signature.
- [ ] Krenko TapForTokens action.
