...
**Status (updated 2026-09-03):** the reviewed orders are now ADOPTED default-ON
(`MTG_5C_ORDER` 6311a8c8, `MTG_MW_ORDERED`+`MTG_AL_ORDER` 47623393, `MTG_KE_ORDER` d0547999,
`MTG_CG_ORDER`) — so these tables, generated with every promotion lever OFF, no longer equal
shipped play. Regenerate with `--cast-order-report` before reusing any of them.
...
**(Superseded 2026-08-25: measured and ADOPTED default-ON, d0547999 — "2 better : 0 worse, and
CHEAPER".)** Original note: **REVIEW HELD (USER, 2026-08-19). Built behind `MTG_KE_ORDER`
(default OFF, byte-identical off); NOT YET MEASURED — the adoption A/B is still owed.** The ruling, verbatim:
