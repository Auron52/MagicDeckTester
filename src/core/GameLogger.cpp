...
thread_local DemonstrateChooser* g_play_demonstrate_chooser = nullptr;
...
thread_local int g_play_cur_main_ordinal = -1;
...
thread_local bool g_unpruned_suppressed   = false;   // see GameLogger.h (hand-back pruning switch)
