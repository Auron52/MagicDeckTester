...
declare -A DECK=( [burn]=decks/burn.txt [slivers]=decks/slivers_vial.txt [th]=decks/treasure_hunt.txt )
declare -A PROF=( [burn]=decks/burn.profile.json [slivers]=decks/slivers_vial.profile.json [th]=decks/treasure_hunt.profile.json )
